...
export const DISCIPLINES = [
  {
    ...
    short: "HRM",
    icon: BookOpen,
    color: "bg-[#EEF0F8] border-[#C9D8E8] text-[#16274A]",
    activeColor: "bg-[#16274A] border-[#16274A] text-white",
    iconBg: "bg-[#DCE6F1]",
    iconColor: "text-[#16274A]",
  ...
  },
  {
    ...
    activeColor: "bg-[#C6A15B] border-[#C6A15B] text-white",
    iconBg: "bg-[#F3EAD5]",
    iconColor: "text-[#9C7C3B]",
  ...
  },
  {
    ...
    short: "POM",
    icon: Briefcase,
    color: "bg-[#E9EEF5] border-[#C0CEDD] text-[#0E1B33]",
    activeColor: "bg-[#0E1B33] border-[#0E1B33] text-white",
    iconBg: "bg-[#DCE6F1]",
    iconColor: "text-[#0E1B33]",
  ...
  },
  {
    ...
    icon: Repeat,
    color: "bg-[#FAF5EA] border-[#E8DCC0] text-[#8F6D33]",
    activeColor: "bg-[#9C7C3B] border-[#9C7C3B] text-white",
    iconBg: "bg-[#F3EAD5]",
    iconColor: "text-[#9C7C3B]",
