...
type Props = {
  fileUrl?: string | null;
  title: string;
  /** Discipline value (e.g. "hrm", "ob") — the PPT cover's base gradient family. */
  subject?: string | null;
  /** Topic slug — nudges the PPT cover's gradient and picks its icon so notes on different topics look different. */
